...
const routes: Routes = [
  ...
  { path: 'alarmFiring',  component: AlarmFiringComponent, data: {animation: 'AlarmFiring'}},
  ...
  { path: 'weather/3days',  component: ThreeDaysForecastComponent, data: {animation: 'WeatherThreeDays'}},
